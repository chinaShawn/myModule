package com.zte.shawn.lotterycheck.behaviour;
...
/**
 * Created by 10192984 on 2016/12/13.
 */
public class RecycleViewFloatBehaviour extends FloatingActionButton.Behavior {
    //我们还可以加一个加速器实现弹射效果
    private FastOutLinearInInterpolator folistener = new FastOutLinearInInterpolator();

    public RecycleViewFloatBehaviour(Context context, AttributeSet attr) {
        super();
    }
