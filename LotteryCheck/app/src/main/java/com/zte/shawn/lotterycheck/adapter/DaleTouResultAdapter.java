 ...
 */
public class DaleTouResultAdapter extends BaseAdapter<DaleTouResultAdapter.MyViewHolder> {
    ...
    public DaleTouResultAdapter(Context context, List<DaLeTou> daLeTouList,MyDaLeTou myDaLeTou) {
        this.context = context;
        this.daLeTouList = daLeTouList;
        this.myDaLeTou = myDaLeTou;
    }
    ...
    @Override
    public DaleTouResultAdapter.MyViewHolder onCompatCreateViewHolder(View realContentView, int viewType) {
    ...
    public void onMyBindViewHolder(MyViewHolder holder, int position) {
        ...
        DaLeTou daLeTou= daLeTouList.get(finalPosition);
        ...
        holder.isHit.setText(Utils.caculateHit(daLeTou,myDaLeTou));
    }
